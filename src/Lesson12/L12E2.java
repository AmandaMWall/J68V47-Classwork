...
public class L12E2 {
    ...
    public static void main(String[] args) {
        ...
        ArrayList<Student> thisClass = loadFile("<path>\\IdeaProjects\\J68V47-Classwork\\out\\production\\J68V47-Classwork\\Lesson12\\students.txt");
        // loop for all objects and show details
        for (Student thisStudent : thisClass) {
